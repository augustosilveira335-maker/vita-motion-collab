...
export const NewTicketScene: React.FC=()=>{
  ...
  return <AbsoluteFill style={{background:'#09151e',overflow:'hidden',perspective:1750}}>
    ...
    <Interactive.Div name="Câmera Novo Chamado" style={{position:'absolute',left:160,top:90,width:1600,height:900,transformOrigin:'50% 50%',translate:interpolate(frame,[0,27,56,82,108,132,165],['105px 45px','0px 0px','-18px -12px','-18px -32px','-36px -30px','-20px 0px','0px 0px'],{...clamp,easing:ease}),scale:interpolate(frame,[0,27,56,82,108,132,165],[.79,.91,.95,.97,.98,.94,.92],{...clamp,easing:ease,output:'perceptual-scale'}),rotate:interpolate(frame,[0,27,165],['1.7deg','0deg','-.5deg'],{...clamp,easing:ease}),opacity:interpolate(frame,[0,9,158,165],[0,1,1,0],clamp)}}>
